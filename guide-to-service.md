...
<div class="container">
	<br><br><br>
		...
		<div class="col-md-3">
			<img class="people" src="../img/people-10.png">
			<h3 style="text-align: center;">Employment<br>Specialist</h3>
		</div>
		<div class="col-md-3">
			<img class="people" src="../img/people-11.png">
			<h3 style="text-align: center;">Henry's Mom</h3>
		</div>
		<div class="col-md-3">
			<img class="people" src="../img/people-12.png">
...
<div class="container" id="infoMeeting">
		<div class="col-md-12">
			<h2 style="font-family: 'Lobster', cursive; font-size: 40px; text-align: center;">Informational Meeting</h2>
		<hr/>
		</div>
	</div>
...
<div class="col-md-3">
			...
			<p style="text-align: left; font-style: italic; font-size: 14px;"><a href="BACI-Employment.github.io/documents.md"><strong>Click Here</strong></a> for forms and documents to be completed.</p>
		</div>
...
<div class="col-md-12">
				<h2 style="font-family: 'Lobster', cursive; font-size: 40px; text-align: center;">Job Seeking</h2>
					<hr/>
				</div>
		</div>
<div class="container">
